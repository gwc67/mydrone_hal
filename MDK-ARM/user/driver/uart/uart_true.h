...
struct uart_cfg_t
{
    uint32_t tx_data_len32;  
    uint32_t rx_data_len32;  
...
struct uart_device_t
{
    ...
    UART_HandleTypeDef **uart_handle_pp;
...
int uart_it_init(struct uart_device_t* me,const struct uart_cfg_t* cfg, UART_HandleTypeDef **uart_handle_pp,
    uint8_t* rx_ring_data,uint8_t* tx_ring_data,const char *name);
#endif